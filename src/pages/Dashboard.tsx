...
import { Service, Category, getContactPhone, getContactEmail } from '@/types/database';
...
const Dashboard = () => {
  ...
  const handleEdit = (service: Service) => {
    ...
    setPhone(getContactPhone(service.contact_info));
    setEmail(getContactEmail(service.contact_info));
