...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'role') THEN
        ALTER TABLE public.users ADD COLUMN role text DEFAULT 'seeker';
    END IF;
END $$;
...
-- Insert 12 real service provider users
INSERT INTO public.users (
  id, name, email, user_type, role, is_verified, verification_status, 
  subscription_plan, can_access_contact, phone
) VALUES 
  ('11111111-1111-1111-1111-111111111111'::uuid, 'John Smith', 'john.plumber@findwho.com', 'provider', 'service_provider', true, 'verified', 'monthly', true, '+1-555-0101'),
  ('22222222-2222-2222-2222-222222222222'::uuid, 'Sarah Tech', 'sarah.tech@findwho.com', 'provider', 'service_provider', true, 'verified', 'yearly', true, '+1-555-0102'),
  ('33333333-3333-3333-3333-333333333333'::uuid, 'Mike Tailor', 'mike.tailor@findwho.com', 'provider', 'service_provider', true, 'verified', 'monthly', true, '+1-555-0103'),
  ('44444444-4444-4444-4444-444444444444'::uuid, 'Lisa Clean', 'lisa.clean@findwho.com', 'provider', 'service_provider', true, 'verified', 'semi_annual', true, '+1-555-0104'),
  ('55555555-5555-5555-5555-555555555555'::uuid, 'Tom Garden', 'tom.garden@findwho.com', 'provider', 'service_provider', true, 'verified', 'yearly', true, '+1-555-0105'),
  ('66666666-6666-6666-6666-666666666666'::uuid, 'Anna Electric', 'anna.electric@findwho.com', 'provider', 'service_provider', true, 'verified', 'monthly', true, '+1-555-0106'),
  ('77777777-7777-7777-7777-777777777777'::uuid, 'David Plumber', 'david.plumber@findwho.com', 'provider', 'service_provider', true, 'verified', 'yearly', true, '+1-555-0107'),
  ('88888888-8888-8888-8888-888888888888'::uuid, 'Emma Repair', 'emma.repair@findwho.com', 'provider', 'service_provider', true, 'verified', 'monthly', true, '+1-555-0108'),
  ('99999999-9999-9999-9999-999999999999'::uuid, 'Chris Style', 'chris.style@findwho.com', 'provider', 'service_provider', true, 'verified', 'semi_annual', true, '+1-555-0109'),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 'Maria Clean', 'maria.clean@findwho.com', 'provider', 'service_provider', true, 'verified', 'yearly', true, '+1-555-0110'),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 'James Green', 'james.green@findwho.com', 'provider', 'service_provider', true, 'verified', 'monthly', true, '+1-555-0111'),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid, 'Sophie Electric', 'sophie.electric@findwho.com', 'provider', 'service_provider', true, 'verified', 'yearly', true, '+1-555-0112')
